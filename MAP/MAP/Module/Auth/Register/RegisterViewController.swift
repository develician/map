...
extension RegisterViewController {
    func setup() {
        let components = [titleLabel, usernameTextField, nameTextField, passwordTextField, registerButton]
        ...
        nameTextField.topAnchor.constraint(equalTo: usernameTextField.bottomAnchor, constant: 24).isActive = true
        ...
        passwordTextField.topAnchor.constraint(equalTo: nameTextField.bottomAnchor, constant: 24).isActive = true
        ...
        registerButton.topAnchor.constraint(equalTo: passwordTextField.bottomAnchor, constant: 24).isActive = true
